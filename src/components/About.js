                ...
                <Grid>
                    <Row>
                        <Col mdPush={4} md={8}>
                            ...
                            <h4>While in college, I learned some Matlab programming on top of my elementary Java from high school.  I elected to teach myself some Python and basic coding principles. This knowledge helped me get my first job out of college.</h4>
                            <h4>After college, I worked at Epic as an Integration Engineer and Project Manager.  Epic offers a full software suite for hospitals and healthcare systems.</h4>
                            <h4>As an Integration Engineer, I helped to develop interfaces that transmit clinical data between Epic and other systems (like vaccination registries, for example).  I was able to work within a large, pre-existing code base in addition to contributing to entirely new code spaces.</h4>
                            ...
                            <h4>Throughout my time at Epic, I continued to spend time learning new programming and web development skills. I used resources like Codeacademy, FreeCodeCamp, Udemy, EdX, and Team Treehouse in addition to standard textbooks.</h4>
                                ...
                                <Carousel>
                                    ...
                                    <Carousel.Item>
                                        ...
                                        <Carousel.Caption>
                                            ...
                                            <p>I don't only teach myself new tech, I also like to flex my creative muscles with music.</p>
                                        </Carousel.Caption>
                                    </Carousel.Item>
                                    <Carousel.Item>
