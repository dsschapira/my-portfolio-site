    ...
    return(
        <div id="about" className="about-container">
            <div className="about-content-container text-center">
                ...
                <h4>While in college, I learned some Matlab programming ontop of my elementary Java from highschool.  I elected to teach myself some Python and basic coding principles, which helped me get my first job out of college.</h4>
